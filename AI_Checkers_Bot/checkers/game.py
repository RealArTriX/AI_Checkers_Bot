...
class Game:
    ...
    def __draw(self):
        '''Displaying the grid of the field and checkers'''
    ...
    def __handle_enemy_turn(self):
        '''Studying the opponent's (computer) move'''
        self.__player_turn = False
    ...
    def __get_required_moves_list(self, side: SideType) -> list[Move]:
        '''Obtaining a list of mandatory moves'''
        moves_list = []
    ...
    def __get_optional_moves_list(self, side: SideType) -> list[Move]:
        '''Obtaining a list of optional moves'''
        moves_list = []
